...
def stock_market():
    ...
    load_do_dw = aql.load_file(
        ...
        load_options={
            ...
            "aws_access_access_key": BaseHook.get_connection('minio').password,
            "endpoint_url": BaseHook.get_connection('minio').host,
        }

    )

    is_api_avaliable() >> get_stock_prices >> store_prices >> format_prices >> get_formatted_csv >> load_do_dw
